...
class TestDiffer {
    ...
    void testDiffJsonStylish() throws Exception {
        ...
        assertThat(Differ.generate(filepath1, filepath2, formatName)).isEqualTo(expectedStylish);
    }
    ...
    void testDiffJsonPlain() throws Exception {
        ...
        assertThat(Differ.generate(filepath1, filepath2, formatName)).isEqualTo(expectedPlain);
    }
    ...
    void testDiffJsonJson() throws Exception {
        ...
        assertThat(Differ.generate(filepath1, filepath2, formatName)).isEqualTo(expectedJson);
    }
